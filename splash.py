...
class splashScreen():
    ...
    def splash(self):
        ...
        canvas=Canvas(f, height=500, width=500, highlightthickness=0, background='Purple')
        basewidth = 220
        ...
        canvas.create_text(250,161, text='Welcome to', font=('Courier New', '18', 'italic'))
        canvas.create_text(250,200, text='Zanvok Accounting', font=('Courier New', '32', 'bold italic' ))
        canvas.create_text(250,239, text='Zanvok Corporation', font=('Helvetica', '18', 'italic'))
        canvas.create_text(250,470, text='(c)copyright: Zanvok Corporation 2022', font=('Times', '9', 'italic'), fill='white')         
